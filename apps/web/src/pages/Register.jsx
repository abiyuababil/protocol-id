    ...
    return (
        <div className="flex min-h-screen w-full flex-row overflow-hidden font-display bg-background-light dark:bg-background-dark text-[#111318] dark:text-white">
            ...
            <div className="flex w-full flex-col justify-center bg-white px-6 py-12 dark:bg-background-dark lg:w-1/2 lg:px-20 xl:px-32">
                ...
                {/* Headlines */}
                <div className="mb-8">
                    <h1 className="mb-2 text-3xl font-bold leading-tight tracking-tight text-[#111318] dark:text-white lg:text-4xl">Buat Akun Baru</h1>
                    <p className="text-base font-normal leading-normal text-[#616f89] dark:text-gray-400">
                        Bergabunglah dengan ribuan konsultan dan partai politik yang menggunakan data kami.
                    </p>
                </div>
                ...
                <form action="#" className="flex w-full flex-col gap-5">
                    ...
                    <div className="flex w-full flex-col gap-2">
                        <label className="text-base font-medium leading-normal text-[#111318] dark:text-white" htmlFor="name">Nama Lengkap</label>
                        <input className="form-input h-14 w-full rounded-lg border border-[#dbdfe6] bg-white px-[15px] text-base font-normal leading-normal text-[#111318] placeholder:text-[#616f89] focus:border-primary focus:outline-0 focus:ring-0 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder:text-gray-500" id="name" placeholder="Nama Lengkap Anda" type="text" />
                    </div>

                    {/* Email Field */}
                    <div className="flex w-full flex-col gap-2">
                        <label className="text-base font-medium leading-normal text-[#111318] dark:text-white" htmlFor="email">Email</label>
                        <input className="form-input h-14 w-full rounded-lg border border-[#dbdfe6] bg-white px-[15px] text-base font-normal leading-normal text-[#111318] placeholder:text-[#616f89] focus:border-primary focus:outline-0 focus:ring-0 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder:text-gray-500" id="email" placeholder="nama@partai.id" type="email" />
                    </div>
                    ...
                    {/* Submit Button */}
                    <button className="mt-2 flex h-12 w-full cursor-pointer items-center justify-center rounded-lg bg-primary px-4 text-base font-bold leading-normal tracking-[0.015em] text-white transition-colors hover:bg-primary-hover focus:ring-4 focus:ring-primary/20" type="button">
                        Daftar
                    </button>
                ...
                {/* Footer Link */}
                <p class="mt-8 text-center text-sm font-normal text-[#616f89] dark:text-gray-400">
                    Sudah punya akun?
                    <Link className="font-bold text-primary hover:underline ml-1" to="/login">Masuk disini</Link>
                </p>
            </div>
                ...
                <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-black/80 via-black/40 to-transparent p-12 text-white xl:p-20">
                    ...
                    <blockquote className="mb-6 max-w-lg">
                        <p className="text-2xl font-bold leading-tight md:text-3xl">
                            "Bergabung dengan Protocol ID memberikan perspektif baru dalam setiap langkah kampanye kami."
                        </p>
                    </blockquote>
                    <div className="flex items-center gap-4">
                        <div className="flex flex-col">
                            <span className="text-sm font-bold">Andi W.</span>
                            <span className="text-xs text-white/80">Ketua Tim Pemenangan</span>
                        </div>
